...
export const pages = {
  ...
  exercise2: `
    ...
    <hr>
      <div class="row">
        <div class="col-sm-4">
           <img src="/public/nophoto.jpeg" alt="" class="img-circle" />
        </div>
        <div class="col-sm-5">
  ...
  exercise3: `
    <div class="container">
        ...
        <img src="/public/chinchilla.jpeg" alt="chinchilla" class="chin mt-5" style="width: '200px'; height: 200px;" />
  ...
  exercise11: `
	...
	<div class="divPreloader">
		<img src="/public/loading.gif" class="imgLoader img-fluid">
	</div> 
  ...
  exercise12: `
    ...
    <img src="/public/1.jpg" class="img-fluid" data-type="jpg">
    <br>
    <br>
    <img src="/public/2.png" class="img-fluid" data-type="png">
    <br>
    <br>
    <div>
      <h1 class="attr"></h1>
		...
		<div class="col-sm-2">
		    <section class="panel">
		        <div class="panel-body">
					...
					<img src="/public/eshop/shirts/thumbs/white.jpg" class="imgThumb img-thumbnail" data-color="white">
					<img src="/public/eshop/shirts/thumbs/gray.jpg" class="imgThumb img-thumbnail" data-color="gray">
					<img src="/public/eshop/shirts/thumbs/black.jpg" class="imgThumb img-thumbnail" data-color="black">
					<img src="/public/eshop/shirts/thumbs/red.jpg" class="imgThumb img-thumbnail" data-color="red">
					<img src="/public/eshop/shirts/thumbs/pink.jpg" class="imgThumb img-thumbnail" data-color="pink">
					<img src="/public/eshop/shirts/thumbs/green.jpg" class="imgThumb img-thumbnail" data-color="green">
		...
		<div class="col-sm-5">
		    <section class="panel">
		        <div class="panel-body">
					...
					<img id="shirtColor" src="/public/eshop/shirts/large/white.jpg" data-color="white">
		...
		<div class="col-sm-4">
		    <section class="panel">
		        <div class="panel-body">
					...
					<p>
						<h4>Rating</h4>
						<img src="/public/eshop/star1.png" class="imgRating">
						<img src="/public/eshop/star1.png" class="imgRating">
						<img src="/public/eshop/star1.png" class="imgRating">
						<img src="/public/eshop/star1.png" class="imgRating">
						<img src="/public/eshop/star2.png" class="imgRating">
						<br>
						<br>
					</p>
					<p>
...
<div class="slideShow">
  <ul>
    <li><img src="/public/slideshow/slide1.png"></li>
    <li><img src="/public/slideshow/slide2.png"></li>
    <li><img src="/public/slideshow/slide3.png"></li>
    <li><img src="/public/slideshow/slide4.png"></li>
  </ul>
</div>
